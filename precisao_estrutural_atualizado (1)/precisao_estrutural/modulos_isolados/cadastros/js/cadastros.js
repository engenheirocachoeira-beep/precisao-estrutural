...
function abrirFormulario(modulo, isNovo = false) {
    ...
    if (isNovo) {
        ...
        if (modulo === 'funcionarios') { document.getElementById('func-index').value = ""; document.getElementById('func-nome').value = ""; document.getElementById('func-cpf').value = ""; document.getElementById('func-nivel').value = "administrador"; document.getElementById('func-cargo').value = "analista pleno"; document.getElementById('func-dt-inicio').value = ""; document.getElementById('func-dt-desligamento').value = ""; document.getElementById('func-dt-nascimento').value = ""; document.getElementById('func-rua').value = ""; document.getElementById('func-numero').value = ""; document.getElementById('func-bairro').value = ""; document.getElementById('func-cidade').value = ""; document.getElementById('func-uf').value = ""; document.getElementById('func-telefone').value = ""; document.getElementById('func-email').value = ""; document.getElementById('func-senha').value = ""; document.getElementById('func-senha').type = 'password'; document.getElementById('btn-toggle-senha-func').textContent = '👁'; document.getElementById('func-cal-seg').value = "8"; document.getElementById('func-cal-ter').value = "8"; document.getElementById('func-cal-qua').value = "8"; document.getElementById('func-cal-qui').value = "8"; document.getElementById('func-cal-sex').value = "8"; funcTempHistoricoValorHora = []; renderizarTabelaHistoricoValorHora(); }
...
// Administrador (único nível que enxerga o item de menu "Cadastro" —
// MENU_POR_NIVEL, core.js — consegue chegar nesta tela) pode ver a
// senha de qualquer colaborador em texto puro, não só trocá-la: o
// campo já vinha preenchido com o valor real ao editar (carregarFuncionarioParaEdicao),
// só ficava mascarado por pontinhos (type="password"). Este botão
// alterna type="password"/"text" no mesmo campo, sem duplicar estado.
function alternarVisibilidadeSenhaFuncionario() {
    const campo = document.getElementById('func-senha');
    const btn = document.getElementById('btn-toggle-senha-func');
    if (!campo) return;
    const estaMostrando = campo.type === 'text';
    campo.type = estaMostrando ? 'password' : 'text';
    if (btn) btn.textContent = estaMostrando ? '👁' : '🙈';
}
