...
**O histórico cronológico de mudanças (as entradas "## Retomada em
AAAA-MM-DD") foi separado pra `CHANGELOG.md`** (2026-08-31) — este
arquivo aqui ficou só com a arquitetura/regras vigentes (o que segue
válido HOJE), sem o log do que foi feito sessão por sessão. Comentários
no código dizendo "ver prompt_gemini.md §X.Y" continuam apontando pra
cá; "prompt_gemini.md, parte N" aponta pro `CHANGELOG.md`.
